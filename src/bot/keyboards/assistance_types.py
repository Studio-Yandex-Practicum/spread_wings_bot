...
assistance_types_keyboard = [
    [
        InlineKeyboardButton(
            ...
            callback_data=States.LEGAL_ASSISTANCE.value
        ),
        InlineKeyboardButton(
    ...
    [
        InlineKeyboardButton(
            text=BACK_BUTTON,
            callback_data=States.BACK_TO_REGION.value
        )
    ]
]

assistance_types_keyboard_markup = InlineKeyboardMarkup(assistance_types_keyboard)
