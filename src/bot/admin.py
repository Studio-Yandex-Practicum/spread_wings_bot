...
class QuestionAdmin(RegionForAdmin):
    ...
    list_display = ("question", "answer", "short_description", "question_type", "get_regions")
    list_filter = ("regions", "question_type")
    search_fields = ("question", "answer", "short_description", "question_type")


@admin.register(Coordinator)
class CoordinatorAdmin(admin.ModelAdmin):

    list_display = ("first_name", "last_name", "region", "email_address", "phone_number", "telegram_account")
    list_filter = ("region", )
    search_fields = ("first_name", "last_name", "email_address", "phone_number", "telegram_account")
